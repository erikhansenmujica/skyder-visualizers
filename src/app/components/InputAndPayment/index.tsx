      ...
      <div className="shadow-md p-4 rounded-md ">
        ...
        <div className="mt-4">
          <h1 className="text-xl text-center">
            {activeTab !== 1 ? t("videoreceivemessage") : t("allfilesrequired")}
          </h1>
          {activeTab === 1 && (
          ...
          {activeTab === 3 && (
            <div className="flex flex-col items-center justify-between">
              <div className="relative flex flex-col items-center mt-8  w-[100%] md:w-[60%] ">
                <video
                  autoPlay
                  playsInline
                  muted
                ...
                >
                  <h2
                    className={
                      "text-white text-xl text-center " + druk.className
                    }
                  >
                    SKYDER COVER <br></br>{" "}
                    <span
              ...
              <div className="relative flex flex-col items-center mt-8 w-[100%] md:w-[60%] ">
                ...
                >
                  <h2
                    className={
                      "text-white text-center text-xl " + druk.className
                    }
                  >
